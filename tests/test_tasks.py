...
class TestSolrCloudTasks(unittest.TestCase):
    ...
    def test_create_sc_collection(self):
    ...
    def test_refresh_sc_collection_for_alias(self):
        ...
        task = refresh_sc_collection_for_alias(
            dag=dag,
            sc_conn=sc_conn,
            sc_coll_name="my-collection",
            sc_alias="my-alias",
